...
const speakerData = [
    {
        id: "keynote-1",
        name: "Russ Poldrack",
        bio: "Dr. Russ Poldrack is a cognitive neuroscientist whose research uses brain imaging and computational methods to understand how the brain gives rise to cognition. In addition to advancing our understanding of the human mind, his work has helped shape modern neuroimaging by promoting rigorous statistical methods, open science, and reproducible research practices. Dr. Poldrack is a leading advocate for transparent and reproducible neuroscience, developing tools, standards, and best practices that have influenced researchers worldwide. His work spans cognitive neuroscience, data science, and scientific methodology, with the goal of making neuroscience more reliable, accessible, and collaborative. He is the Albert Ray Lang Professor and Chair of the Department of Psychology at Stanford University and the author of several influential books on neuroimaging, statistics, and reproducible science.",
